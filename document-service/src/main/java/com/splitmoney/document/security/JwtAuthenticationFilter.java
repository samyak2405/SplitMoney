package com.splitmoney.document.security;
...
public class JwtAuthenticationFilter extends OncePerRequestFilter {
    ...
    public static final String AUTHENTICATED_USER_EMAIL_ATTR = "authenticatedUserEmail";
    ...
    protected void doFilterInternal(
        ...
        try {
            ...
            if (email != null) {
                request.setAttribute(AUTHENTICATED_USER_EMAIL_ATTR, email);
            }
            filterChain.doFilter(request, response);
    ...
    private void unauthorized(HttpServletResponse response, String message) throws IOException {
        ...
        response.getWriter().write(
                "{\"success\":false,\"responseCode\":\"401\",\"responseMessage\":\"" + message + "\"}"
        );
    }
}
